...
function computeLocalEnergy(system::slaterJastrowNNAnalytical, interacting = false)
    ...
    for i=1:N 
        ...
        # println(gradientSlaterDeterminant, gradientSlaterGaussian, gradientJastrow, gradientNN)
        # println(laplacianSlaterDeterminant, laplacianSlaterGaussian, laplacianJastrow, laplacianNN)
        ...
        laplacian = laplacianSlaterDeterminant  + laplacianNN  + laplacianSlaterGaussian + laplacianJastrow
...
function computeLocalEnergy(system::gaussianJastrowNNAnalytical, iteration, interacting = false)
    N = system.numParticles
    numDimensions = system.numDimensions
    localEnergy = 0
    harmonicTerm = 0
    ...
    for i=1:N 
        ...
        grad =  gradientSlaterGaussian + gradientSimpleJastrow + gradientNN

        laplacian = laplacianSlaterGaussian + laplacianSimpleJastrow + laplacianNN
